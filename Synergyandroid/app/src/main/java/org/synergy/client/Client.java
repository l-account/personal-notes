...
public class Client implements EventTarget {
	...
	public void connect () {
		...
		try {
            ...
            Log.debug("Connected to " + serverAddress.getHostname()+ ":" + serverAddress.getPort());
    ...
    private void handleHello () {
        ...
        try {
            ...
            // Grab the hostname
            HelloBackMessage helloBackMessage= new HelloBackMessage (helloMessage.getMajorVersion(), helloMessage.getMinorVersion(),
                    name,"zh");
            helloBackMessage.write (dout);
