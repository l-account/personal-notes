...
public class ServerProxy {
    ...
    /*
    //////////// serverproxy construction in client part
     */
	...
	protected Result parseHandshakeMessage () throws IOException {
		...
		case CINFOACK:
			infoAcknowledgment ();
			// handshake is complete  todo:for android simplyfied
	...
	private void handleData () {
		Log.debug ("client handle data called");
		try {
	...
	private void sendInfo (ClientInfo info) {
		...
		InfoMessage infomessage=new InfoMessage (info.getScreenPosition ().left,
	...
	/*
	///// serverproxy (read from server) will call method (actual in client)
	 */
